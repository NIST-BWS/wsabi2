...
@synthesize animateHorizontal = _animateHorizontal;
...
- (void)show
{
    ...
    if (self.animateHorizontal) {
        _view.center = CGPointMake(-_view.bounds.size.width, floorf([BlockBackground sharedInstance].bounds.size.height * 0.5));
